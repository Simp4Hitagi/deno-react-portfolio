...
const AboutLayout = () => {
    return (
        <section className="container grid grid-cols-2 h-screen">
            <div className="pl-16">
                <div className="about-text pt-24 bg-black transition ease-in-out duration-1000 hover:-translate-x-10 hover:scale-100">
                    ...
                    <p className="text-left text-white text-base pt-6 px-8">
                ...
                <div className="about-image transition ease-in-out duration-1000  hover:-translate-x-10 hover:scale-100">
                    <Image
                        className="ml-0 border-t-4 border-white object-cover"
                        src={deno}
                        alt="deno"
                    />
                </div>
